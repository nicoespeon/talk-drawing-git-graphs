...
//
// WHY of the talk: You can **hack** your own problems!
//
// Shortcuts:
...
[json2tsd](https://github.com/nicoespeon/gitgraph.js/blob/gitgraph.js/scripts/json2tsd.test.js) > generate TS types from code documentation
...
## 💬 Pair-programming ease communication
...
- 40min of achieving the challenge, no matter what
...
## ✅ TDD and types are super-effective
...
- 2 rendering libs: _@gitgraph/js_ & _@gitgraph/react_
- Give you a git-like API
- Render SVG graph in the browser
- Types, tests & stories
...
TK: demo of `@gitgraph/react` usage
